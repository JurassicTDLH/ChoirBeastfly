...
internal class Administrator : MonoBehaviour
{
    ...
    private void ModifyControlFSM()
    {
        ...
        if (name.Contains("(1)"))
        {
            summonPos = new Vector2(22, 9);
        }
        else
        {
            summonPos = new Vector2(38, 9);
        }
        ...
        //var shiftState = fsm.GetState("Check Pos");
        //shiftState.Actions = [new Wait { time = 0f, finishEvent = FsmEvent.Finished, realTime = false },];
        flyInState.Actions = [
